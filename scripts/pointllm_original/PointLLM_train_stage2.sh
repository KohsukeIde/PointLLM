...
model_name_or_path=outputs/PointLLM_train_stage1/PointLLM_train_stage1_pctag # Path to the output dir of stage 1 training
data_path=data/objaverse_data
anno_path=data/anno_data/complex_instruction_stage2_multi_pc_70K.json
